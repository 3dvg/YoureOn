...
/*PROTECTED REGION ID(usingYoureOnGenNHibernate.CP.YoureOn_Contenido_votar) ENABLED START*/
...
{
public void Votar (int p_oid, float puntos)
{
        /*PROTECTED REGION ID(YoureOnGenNHibernate.CP.YoureOn_Contenido_votar) ENABLED START*/
